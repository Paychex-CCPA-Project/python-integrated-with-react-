...
var ListView = function (props) {
    ...
    var controllerProps = (0, ra_core_1.getListControllerProps)(props); // deprecated, to be removed in v4
    var listContext = (0, ra_core_1.useListContext)(props);
    ...
    return (React.createElement("div", __assign({ className: (0, classnames_1.default)('list-page', classes.root, className) }, sanitizeRestProps(rest)),
