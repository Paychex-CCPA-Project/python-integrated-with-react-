...
var ListActions = function (props) {
    ...
    var _a = (0, ra_core_1.useListContext)(props), currentSort = _a.currentSort, displayedFilters = _a.displayedFilters, filterValues = _a.filterValues, basePath = _a.basePath, selectedIds = _a.selectedIds, showFilter = _a.showFilter, total = _a.total;
    var resource = (0, ra_core_1.useResourceContext)(rest);
    var hasCreate = (0, ra_core_1.useResourceDefinition)(rest).hasCreate;
