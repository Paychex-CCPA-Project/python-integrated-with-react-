...
var LayoutWithoutTheme = /** @class */ (function (_super) {
    ...
    LayoutWithoutTheme.prototype.render = function () {
        ...
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement("div", __assign({ className: (0, classnames_1.default)('layout', classes.root, className) }, props),
...
), react_router_dom_1.withRouter, (0, styles_1.withStyles)(styles, { name: 'RaLayout' }))(LayoutWithoutTheme);
var Layout = function (_a) {
    var themeOverride = _a.theme, props = __rest(_a, ["theme"]);
    var themeProp = (0, react_1.useRef)(themeOverride);
    var _b = (0, react_1.useState)(function () { return (0, createMuiTheme_1.createMuiTheme)(themeOverride); }), theme = _b[0], setTheme = _b[1];
    (0, react_1.useEffect)(function () {
        if (themeProp.current !== themeOverride) {
            themeProp.current = themeOverride;
            setTheme((0, createMuiTheme_1.createMuiTheme)(themeOverride));
        }
