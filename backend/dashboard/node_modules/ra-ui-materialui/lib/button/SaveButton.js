...
var SaveButton = function (props) {
    ...
    var formContext = (0, ra_core_1.useFormContext)();
    var _d = (0, ra_core_1.useSaveContext)(props), setOnSuccess = _d.setOnSuccess, setOnFailure = _d.setOnFailure, setTransform = _d.setTransform;
    ...
    return (react_1.default.createElement(Button_1.default, __assign({ className: (0, classnames_1.default)(classes.button, className), variant: variant, type: type, onClick: handleClick, color: saving ? 'default' : 'primary', "aria-label": displayedLabel, disabled: disabled }, (0, Button_2.sanitizeButtonRestProps)(rest)),
