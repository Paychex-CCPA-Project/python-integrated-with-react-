...
var useStyles = (0, styles_1.makeStyles)(function (theme) { return ({
    updateButton: {
        ...
        '&:hover': {
            backgroundColor: (0, colorManipulator_1.alpha)(theme.palette.error.main, 0.12),
...
var BulkUpdateWithConfirmButton = function (props) {
    ...
    var unselectAll = (0, ra_core_1.useUnselectAll)();
    ...
    var _g = (0, ra_core_1.useUpdateMany)(resource, selectedIds, data, {
    ...
    return (React.createElement(react_1.Fragment, null,
        React.createElement(Button_1.default, __assign({ onClick: handleClick, label: label, className: classes.updateButton }, sanitizeRestProps(rest)), icon),
