...
var ReferenceInput = function (props) {
    ...
    var inputProps = (0, ra_core_1.useInput)(__assign({ format: format, onBlur: onBlur, onChange: onChange, onFocus: onFocus, parse: parse, validate: validate }, rest));
    return (react_1.default.createElement(exports.ReferenceInputView, __assign({}, inputProps, rest, (0, ra_core_1.useReferenceInputController)(__assign(__assign({}, rest), inputProps)))));
};
...
var ReferenceInputView = function (props) {
    ...
    (0, ra_core_1.warning)(helperText !== undefined && helperText !== false, "<ReferenceInput> doesn't accept a helperText prop. Set the helperText prop on the child component instead");
