...
var Resource = /** @class */ (function (_super) {
    ...
    Resource.prototype.render = function () {
        ...
        return (react_1.default.createElement(react_router_dom_1.Switch, null,
            create && (react_1.default.createElement(react_router_dom_1.Route, { path: match.path + "/create", render: function (routeProps) { return (react_1.default.createElement(WithPermissions_1.default, __assign({ render: function (props) {
                        return react_1.createElement(create, __assign({ basePath: basePath }, props));
                    } }, routeProps, resource))); } })),
            show && (react_1.default.createElement(react_router_dom_1.Route, { path: match.path + "/:id/show", render: function (routeProps) { return (react_1.default.createElement(WithPermissions_1.default, __assign({ render: function (props) {
                        return react_1.createElement(show, __assign({ basePath: basePath, id: decodeURIComponent(props.match
                                .params.id) }, props));
                    } }, routeProps, resource))); } })),
            edit && (react_1.default.createElement(react_router_dom_1.Route, { path: match.path + "/:id", render: function (routeProps) { return (react_1.default.createElement(WithPermissions_1.default, __assign({ render: function (props) {
                        return react_1.createElement(edit, __assign({ basePath: basePath, id: decodeURIComponent(props.match
                                .params.id) }, props));
                    } }, routeProps, resource))); } })),
            list && (react_1.default.createElement(react_router_dom_1.Route, { path: "" + match.path, render: function (routeProps) { return (react_1.default.createElement(WithPermissions_1.default, __assign({ render: function (props) {
