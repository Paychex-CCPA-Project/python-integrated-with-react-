...
var useNotify = function () {
    ...
    return (0, react_1.useCallback)(function (message, type, messageArgs, undoable, autoHideDuration, multiLine) {
        if (messageArgs === void 0) { messageArgs = {}; }
        if (undoable === void 0) { undoable = false; }
        if (typeof type === 'string') {
            (0, warning_1.default)(true, 'This way of calling useNotify callback is deprecated. Please use the new syntax passing notify("[Your message]", { ...restOfArguments })');
            dispatch((0, notificationActions_1.showNotification)(message, type || 'info', {
            ...
            var messageType = type.type, options = __rest(type, ["type"]);
            dispatch((0, notificationActions_1.showNotification)(message, messageType, options));
        }
    }, [dispatch]);
};
