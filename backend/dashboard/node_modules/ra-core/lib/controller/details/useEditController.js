...
var useEditController = function (props) {
    ...
    var _c = (0, saveModifiers_1.useSaveModifiers)({ onSuccess: onSuccess, onFailure: onFailure, transform: transform }), onSuccessRef = _c.onSuccessRef, setOnSuccess = _c.setOnSuccess, onFailureRef = _c.onFailureRef, setOnFailure = _c.setOnFailure, transformRef = _c.transformRef, setTransform = _c.setTransform;
    var _d = (0, dataProvider_1.useGetOne)(resource, id, {
    ...
    var _e = (0, dataProvider_1.useUpdate)(resource, id, {}, // set by the caller
