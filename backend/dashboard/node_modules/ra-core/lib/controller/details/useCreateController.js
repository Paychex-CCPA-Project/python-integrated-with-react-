...
var useCreateController = function (props) {
    ...
    var recordToUse = (0, exports.getRecord)(location, record);
    ...
    var _b = (0, saveModifiers_1.useSaveModifiers)({ onSuccess: onSuccess, onFailure: onFailure, transform: transform }), onSuccessRef = _b.onSuccessRef, setOnSuccess = _b.setOnSuccess, onFailureRef = _b.onFailureRef, setOnFailure = _b.setOnFailure, transformRef = _b.transformRef, setTransform = _b.setTransform;
    var _c = (0, dataProvider_1.useCreate)(resource), create = _c[0], saving = _c[1].loading;
    var save = (0, react_1.useCallback)(function (data, redirectTo, _a) {
