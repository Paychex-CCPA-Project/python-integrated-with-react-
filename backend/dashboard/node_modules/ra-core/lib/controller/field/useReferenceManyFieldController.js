...
var useReferenceManyFieldController = function (props) {
    ...
    // sort logic
    var _d = (0, useSortState_1.default)(initialSort), sort = _d.sort, setSortObject = _d.setSort;
    ...
    // selection logic
    var _e = (0, useSelectionState_1.default)(), selectedIds = _e.selectedIds, onSelect = _e.onSelect, onToggleItem = _e.onToggleItem, onUnselectItems = _e.onUnselectItems;
    // filter logic
    ...
    var referenceId = (0, get_1.default)(record, source);
    var _h = (0, dataProvider_1.useGetManyReference)(reference, target, referenceId, { page: page, perPage: perPage }, sort, filterValues, resource, {
