# Generated by Django 3.1.3 on 2021-10-30 04:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='DataMethod',
            fields=[
                ('dataRequestId', models.IntegerField(auto_created=True, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataRequestId', models.ForeignKey(auto_created=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.datamethod')),
            ],
        ),
    ]
